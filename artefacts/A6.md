...
FROM (("Reviews" INNER JOIN "SerialKeys" ON "SerialKeys".sk_id = "Reviews".sk_id) INNER JOIN "Users" ON "SerialKeys".user_id = "Users".user_id) WHERE "SerialKeys".product_id = $productId ORDER BY "Reviews".rating DESC;  ```          |
