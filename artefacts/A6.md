...
$BODY$
BEGIN
    IF EXISTS (SELECT * FROM "Products" WHERE NEW.product_id = "Products".product_id AND NEW.user_id = "Products".user_id) THEN
...
1. First submission
2. Added trigger and queries
3. Minor fixes
 
***
 
GROUP1744, 11/04/2018
