...
| Index attribute | start_date, end_date   				|
| Index type      | B-tree            			 |
| Cardinality | Medium |
| Clustering      | Yes              |
...
| SQL code        | ``` CREATE INDEX promotions ON "Discounts" (start_date) WHERE (CURRENT_DATE BETWEEN "Discounts".begin_date AND "Discounts".end_date); ``` |
