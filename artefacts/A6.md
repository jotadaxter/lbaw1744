...
| __Query description__ | User's profile                       |
...
| __Query description__ | Product profile                       |
| __Query frequency__   | hundreds per day                   |
...
| __Query description__ | My wish list                      |
| __Query frequency__   | dozens per day                   |
| __SQL__ |```SQL  SELECT product_id  FROM "Wishlists"  WHERE "Wishlists".user_id = $userId; ```          |

| Title | Explain| 
| --------------------- | -------------------------------------- |
| __Query reference__   | _SELECT04_                               |
| __Query description__ | My Bought Products                    |
| __Query frequency__   | dozens per day                   |
| __SQL__ |```SQL  SELECT product_id  FROM "PurchasedProducts"  WHERE "Purchases".user_id = $userId AND "PurchasedProducts".purchase.id = "Purchases".purchase_id; ```          |
 
| Title | Explain| 
| --------------------- | -------------------------------------- |
| __Query reference__   | _SELECT05_                               |
| __Query description__ | Search                      |
| __Query frequency__   | hundreds per day                   |
| __SQL__ |```SQL  SELECT * FROM "Products" WHERE name LIKE %$search% OR description LIKE %$search% ORDER BY name;  ```          |

| Title | Explain| 
| --------------------- | -------------------------------------- |
| __Query reference__   | _SELECT06_                               |
| __Query description__ | Select reviews for product                    |
| __Query frequency__   | hundreds per day                   |
| __SQL__ |```SQL  SELECT rating, comment FROM "Reviews" WHERE "SerialKeys".product_id = $productId AND "SerialKeys".sk_id = "Reviews".sk_id  ```          |
