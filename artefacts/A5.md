...
| ------------------ | -------------------------------------------------------------------- |
| R01                | User(__user_id__, username UK NN, password NN, fullname NN, email UK NN, phoneNumber NN, birthDate NN, admissionDate NN DF Today, state NN CK state IN UserState, admin NN, image_path)                                         |
