...
| R04                | Product(__product_id__, description NN, release_date NN, system NN, price NN, rating NN, image_path)       |
| R05                | Buyer(__buyer_id__ → User NN, acc_points NN)                       |
| R06                | Buyer(__buyer_id__ → User NN, acc_points NN)                       |
| R03                | Buyer(__buyer_id__ → User NN, acc_points NN)                       |
