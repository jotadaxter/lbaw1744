...
Each _Storyboard_ is a sequence of interfaces explaining how navigation within the website's pages (presented in the following section of this artefact) is made.
 ...
 ![image 52 - Login](/images/storyboards/a3_login.jpg "Optional Title")  
 Image 52 - Login
 
 ![image 53 - Buy Product](/images/storyboards/a3_buy.jpg "Optional Title")  
 Image 53 - Buy Product
 
 Example of navigation through the user's dropdown box of options:
 
 ![image 54 - User Profile](/images/storyboards/a3_profile.jpg "Optional Title")  
 Image 54 - User Profile
 
 Example of navigation through the website's footer options:
 
 ![image 55 - About](/images/storyboards/a3_about.jpg "Optional Title")  
 Image 55 - About
