...
| US03       | Search               | High     | 60%         | As a User, I want to search for a specific product(s), its Seller and/or tag(s)                                             | All         |                   |             |
...
| US32       | Remove Product       | High     | 0%      | As a Seller, I want to remove a product from sale                                                                          | All         |
...
| US26       | Delete Product from Wishlist | Medium   | 0%     | As a Member, I want to remove a product from my Wishlist               | All         |
...
| US47       | Rate                         | High     | 0%       | As a Buyer, I want to rate a product                                   | All         |
...
| US44       | Remove Product   | High     | 0%       | As a Buyer, I want to remove a product from my cart                   | All         |
