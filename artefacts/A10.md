...
| US06       | Top Selling Products | High     | User        | As a User, I want to consult a list of the most selling products                                                            |             |
| US07       | Product Page         | High     | User        | As a User, I want to access a product's page, with all its specifications and other pertinent information                   |             |
