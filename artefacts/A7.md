...
* Search Product Page /product_search
* Search Product API
* View Product
* Add Product Form
* Add Product Action
...
* R301: View Reviews /products/{id}/reviews
* R302: Add Review /products/{id}/reviews
* R303: Edit Review /products/{product_id}/reviews/{review_id}
* R304: Delete Review /products/{id}/reviews/{id}
* R305: View Wish list /users/{id}/wishlist/
* R306: Add to Wish list /users/{id}/wishlist/products/{id}
* R307: Remove from Wish list /users/{id}/wishlist/products/{id}
