...
* R401: Checkout products in cart
...
| URL         | /users/{user_id}/cart/products{products_id}                  |                                                          |
|-------------|--------------------------------------------------------------|----------------------------------------------------------|
| Description | This web resource allows a user to add a product to its cart |                                                          |
| Method      | POST                                                         |                                                          |
| Parameters  | +user_id: integer                                            | User Id                                                  |
|             | +product_id: integer                                         | Product Id                                               |
| Returns     | 200 OK                                                       | The product was successfully added to the cart.          |
|             | 400 Bad Request                                              | Error. Error message is specified via a HTTP header.     |
|             | 403 Forbidden                                                | Error. Access to page or action is forbidden.            |
|             | 404 Not Found                                                | Error. No user with the specified primary key exists.    |
