...
<td>Web resources associated with reviews and wish list, includes the following system features: add, list and delete reviews; add and remove items from the wish list.</td>
</tr>
<tr>
<th>M04: Cart and Checkout</th>
<td>Web resources associated with cart and checkout, includes the following system features: view, checkout and remove from cart; do checkout payment.</td>
</tr>
<tr>
<th>M05: User Administration</th>
<td>Web resources associated with user management, specifically: view and search users, delete or block user accounts, view and change user information, and view system access details for each user.</td>
</tr>
<tr>
<th>M06: Static pages</th>
<td>Web resources associated with static content such as: About, Contacts, 404 (resource not found), Terms of Service and Privacy</td>
</tr>
</tbody>
</table>
...
References:
[UI08](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A3.md#ui08-sign-in)
[R102](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r102-login-action)
...
References:
[R101](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r101-login-form)
[R106](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r106-view-profile)
...
References:
[UI07](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A3.md#ui07-register)
...
<tr>
<th>Description</th>
<td>This web resource inserts the user into the system. Redirects to the user profile page on success and the register form on failure.<td> </td>
</tr>
<tr>
<th>Method</th>
<td>POST</td><td> </td>
...
<tr>
<th></th>
<td>?img: file</td><td>Profile Picture Path </td>
</tr>
<tr>
<th>Redirects</th>
<td>R106</td><td>Success </td>
...
References:
[R104](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r104-register-form)
[R106](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r106-view-profile)
...
References:
[UI03](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A3.md#ui03-profile)
...
References:
[UI04](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A3.md#ui04-edit-profile)
...
References:
[R106](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r106-view-profile)
[R107](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r107-edit-profile-form)
...
References:
~~UI10~~
[R110](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r110-password-recovery-action)
...
References:
[UI01](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A3.md#ui01-home)
[R109](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r109-password-recovery-form)
...
References:
~~UI15~~
[R112](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r112-password-change-form)
...
References:
~~UI10~~
[R113](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r113-password-change-action)
...
* R212: Remove Product's Image Form /products/{product_id}
* R213: Remove Product's Image Action /products/{product_id}
* R214: View Product's Images /products/{product_id}
...
References:
[UI05](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A3.md#ui05-products-list)
[R202](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r202-search-product-api)
...
References:
[JSON302](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#json302-search-product-api-product)
...
References:
[UI06](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A3.md#ui06-single-product)
...
References:
~~UI13~~
[R205](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r205-add-product-action)
...
<tr>
<th></th>
<td>?img: file</td><td>Product Picture Path </td>
</tr>
<tr>
<th>Redirects</th>
...
References:
[R203](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r203-view-product)
[R204](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r204-add-product-form)
...
References:
~~UI14~~
[R207](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r207-edit-product-action)
...
References:
[R203](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r203-view-product)
[R206](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r206-edit-product-form)
...
References:
~~UI16~~
[R209](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r209-remove-product-action)
...
References:
~~UI17~~
[R211](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r211-add-image-to-product-action)
...
References:
[R203](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r203-view-product)
[R210](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r210-add-image-to-product-form)

#### R212: Remove Product's Image Form
<table>
<tbody>
<tr>
<th>URL</th>
...
<tr>
<th>Description</th>
<td>Page with a form to remove a product's image.</td><td></td>
</tr>
<tr>
<th>Method</th>
<td>GET</td><td></td>
...
References:
[R213](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r213-remove-product-action)

#### R213: Remove Product's Image Action
<table>
<tbody>
<tr>
<th>URL</th>
...
<tr>
<th>Description</th>
<td>This web resource removes the product's image from the system. Redirects to the product's page on success and the Edit Product page on failure.
</td><td></td>
</tr>
<tr>
<th>Method</th>
...
<tr>
<th></th>
<td>+img_path: integer</td><td>Image Path</td>
</tr>
<tr>
<th></th>
<td>+username: string</td><td>Username of the owner of the Product</td>
...
<tr>
<th>Redirects</th>
<td>UI06</td><td>Success</td>
</tr>
<tr>
<th></th>
<td>R212</td><td>Error</td>
</tr>
<th>Permissions</th>
<td>OWN, ADM</td><td></td>
</tr>
...
References:
[UI06](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A3.md#ui06-single-product)
[R212](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r212)

#### R214: View Product's Images
<table>
<tbody>
<tr>
<th>URL</th>
...
<tr>
<th>Description</th>
<td>Shows the product's images.</td><td></td>
</tr>
<tr>
<th>Method</th>
<td>GET</td><td></td>
...
References:
[JSON301](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#json301-view-reviews-review)
...
References:
~~UI12~~
[R307](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r307-remove-from-wish-list)

#### R306: Add Product to Wish list
...
* R402: Add Product to Cart /users/{user_id}/cart/
* R403: Remove Product from Cart /users/{user_id}/cart/products/{product_id}
* R404: Checkout Products in Cart /users/{user_id}/cart/products/
* R405: Checkout Payment Form /users/{user_id}/cart/

#### R401: View Products in Cart
...
| __URL__         | /users/{user_id}/cart/products/{product_id}        |                                                             |
|-----------------|----------------------------------------------------|-------------------------------------------------------------|
| __Description__ | Removes a product from the cart.				               |                                                             |
| __Method__      | DELETE                                             |                                                             |
| __Parameters__  | +user_id: integer                                  | User Id                                                     |
|                 | +product_id: integer                               | Product Id                                                  |
...
#### R404: Checkout Products in Cart

| __URL__         | /users/{user_id}/cart/products/                     |                            |
|-----------------|--------------------------|-------------------------------------------------------|
| __Description__ | Purchase all the products in its cart               |                            |
| __Method__      | PUT                      |                                                       |
| __Parameters__  | +user_id: integer        | User Id                                               |
...
References:
~~UI19~~
[R401](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A7.md#r401-vew-products-in-cart)


### 3.5 Module M05: User Administration
...
References:
[UI09](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A3.md#ui09-admin)
...
References:
[UI02](https://github.com/jotadaxter/lbaw1744/blob/master/artefacts/A3.md#ui02-about)
...
### JSON302: Search Product API: {product}[]
```json
{
  "products": [
    {
...
1. First submission
2. Added more web resources
3. Added resource reference links
4. Minor content and bug fixes
