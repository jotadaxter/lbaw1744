...
__R401: Checkout products in cart__
...
__R402: Add Product to cart__

| __URL__         | /users/{user_id}/cart/products{products_id}                  |                                                          |
|-------------|--------------------------------------------------------------|----------------------------------------------------------|
| __Description__ | This web resource allows a user to add a product to its cart |                                                          |
| __Method__      | POST                                                         |                                                          |
| __Parameters__  | +user_id: integer                                            | User Id                                                  |
|             | +product_id: integer                                         | Product Id                                               |
| __Returns__     | 200 OK                                                       | The product was successfully added to the cart.          |
|             | 400 Bad Request                                              | Error. Error message is specified via a HTTP header.     |
|             | 403 Forbidden                                                | Error. Access to page or action is forbidden.            |
|             | 404 Not Found                                                | Error. No user with the specified primary key exists.    |
