<?php $__env->startSection('content'); ?>
    <div class="about container panel-limit-margin">
        ...
        <div class="container padded">
            ...
            <h2 class="terms_title">Privacy Policy</h2>
            <br>
            <div class="white-box scrollbar-window">
                <p>This Privacy Policy governs the manner in which Vapor collects, uses, maintains and discloses information collected from users (each, a "User") of the http://lbaw1744.lbaw-prod.fe.up.pt/ website ("Site").</p>
                ...
                <p>Vapor may collect and use Users personal information for the following purposes:</p>
                <ul>
                    <li>
                ...
                <p>Vapor has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site, revise the updated date at the bottom of this page and send you an email. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
                ...
                <p>This document was last updated on May 03, 2018</p>
