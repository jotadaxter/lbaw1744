        ...
        <div class="shift-down">
            ...
            <div class="col-sm-3 col-md-2 col-lg-2 btn-group">
                <div class="dropdown ">
                    ...
                    <ul class="dropdown-menu">
                        <li><a id="view_profile" href="<?php echo e(route('profile', Auth::id())); ?>">View Profile <span class="glyphicon glyphicon-user pull-right"></span></a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo e(route('myProducts', Auth::id())); ?>">My Products <span class="glyphicon glyphicon-th-list pull-right"></span></a></li>
                        <li class="divider"></li>

                        <?php if(Auth::user()->admin): ?>
                            <li><a href="<?php echo e(route('adminPage')); ?>">Admin Menu <span class="glyphicon glyphicon-user pull-right"></span></a></li>
                            <li class="divider"></li>

                        <?php endif; ?>

                        <li><a href="<?php echo e(route('wishlist', Auth::id())); ?>">Wishlist <span class="glyphicon glyphicon-heart pull-right"></span></a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo e(route('settings', Auth::id())); ?>">Settings <span class="glyphicon glyphicon-cog pull-right"></span></a></li>
                        <li class="divider"></li>
                        <li><a id="signOut_btn" href="<?php echo e(route('logout')); ?>">Sign Out <span class="glyphicon glyphicon-log-out pull-right"></span></a></li>
                    </ul>
                </div>
            ...
            <div class="col-sm-2 col-md-2 col-lg-2 btn-group shift-up">
                <a class="register_btn btn button">
                    <img id="profile_picture" class="img-rounded img-thumbnail" src="/uploads/profile_images/<?php echo e(Auth::user()->img); ?>" alt="profile_picture" height="60" width="60">
                </a>
            </div>
        </div>
    </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a class=" active dropdownbox-element" style="color:black;" data-toggle="dropdown"
                       role="button" aria-haspopup="true" aria-expanded="false"><?php echo e($user->username); ?></a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item-element" style="color:black;" href="/profile/<?php echo e(Auth::id()); ?>">
                                View Profile
                            </a>
                        </li>
                        ...
                        <?php if(Auth::user()->admin): ?>
                            <li><a class="dropdown-item-element" style="color:black;" href="<?php echo e(route('adminPage')); ?>">
                                    Admin Menu
                                </a>
                            </li>
                            <hr class="hr_header2">
                        ...
                        <li><a class="dropdown-item-element" style="color:black;" href="<?php echo e(route('logout')); ?>">Sign Out</a></li>
                    </ul>
                </li>
            </ul>
        </div>
