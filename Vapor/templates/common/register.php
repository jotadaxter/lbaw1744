...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-1" style="background-color: white; border-radius: 10px;">
            <h1 style="text-align: center">Register</h1>
            <div class="col-md-6 col-lg-6 col-lg-offset-3" style="background-color: white; border-radius: 10px;">
