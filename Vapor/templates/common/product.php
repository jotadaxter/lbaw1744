...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
			...
			<div class="product-desc"><b>Systems:</b><img src="res/images/windows_logo.png" width="25"></div><br>
			  <hr>
        </div>
		<div class="col-md-4">
			<br><br><br>			
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="title-descriptor">Ableton Live is a software music sequencer and digital audio workstation for macOS and Windows. 
