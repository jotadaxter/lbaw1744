            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-12">
                                <img src="res/images/product.png" style="width:210px;height: 210px;" class="img-rounded" alt="Cinque Terre" width="400" height="400">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="indent-box">
                            ...
                            <div class="product-desc"><b>Systems:</b><img src="res/images/windows_logo.png" style="width:20px;" width="420"></div>
                        </div>
                        <br>
                        <hr>
                    </div>
