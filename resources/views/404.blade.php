				...
				<table width="400" cellpadding="3" cellspacing="5">
					<tr>
						<td id="tableProps" valign="top" align="left">
							<img id="pagerrorImg" SRC="\icons\pagerror.ico" alt="pagerror.ico" width="25" height="33">
						</td>
						<td id="tableProps2" align="left" valign="middle" width="360">
							<h1 id="errortype"  style="COLOR: black; font-size: 13pt; font-family: sans-serif">
								<span id="errorText">The page cannot be found</span>
							</h1>
						</td>
					</tr>
					<tr>
