...
INSERT INTO "Products" (hidden, product_id, user_id, description, release_date, operating_system, price, logo_path, name) VALUES (FALSE, 200, 105, 'daw for live mixing and production', '2015/10/20', 'wml', 599, '<input type="image" src="/uploads/product_images/ableton9.jpg" width="30">', 'ableton 9 live suite');
INSERT INTO "Products" (hidden, product_id, user_id, description, release_date, operating_system, price, logo_path, name) VALUES (FALSE, 201, 106, 'image editing software', '2016/2/14', 'wml', 599, '<input type="image" src="/uploads/product_images/photoshop.jpg" width="30">', 'adobe photoshop');
INSERT INTO "Products" (hidden, product_id, user_id, description, release_date, operating_system, price, logo_path, name) VALUES (FALSE, 202, 107, 'programming ide', '2018/3/12', 'w', 199, '<input type="image" src="/uploads/product_images/visualstudio.jpg" width="30">', 'visual studio 2018');
INSERT INTO "Products" (hidden, product_id, user_id, description, release_date, operating_system, price, logo_path, name) VALUES (FALSE, 203, 108, 'video editing software', '2014/1/22', 'wm', 299, '<input type="image" src="/uploads/product_images/sonyvegas.jpg" width="30">', 'sony vegas pro');
INSERT INTO "Products" (hidden, product_id, user_id, description, release_date, operating_system, price, logo_path, name) VALUES (FALSE, 204, 109, '3d rendering and editing software', '2013/10/12', 'wml', 0, '<input type="image" src="/uploads/product_images/blender.jpg" width="30">', 'blender');
INSERT INTO "Products" (hidden, product_id, user_id, description, release_date, operating_system, price, logo_path, name) VALUES (FALSE, 205, 105, 'synthetizer plug in for ableton', '2017/11/21', 'wml', 29, '<input type="image" src="/uploads/product_images/massive.jpg" width="30">', 'ableton massive plugin');
INSERT INTO "Products" (hidden, product_id, user_id, description, release_date, operating_system, price, logo_path, name) VALUES (FALSE, 206, 106, 'vector graphic design software', '2016/4/1', 'wml', 99, '<input type="image" src="/uploads/product_images/ilustrator.jpg" width="30">', 'adobe ilustrator');
INSERT INTO "Products" (hidden, product_id, user_id, description, release_date, operating_system, price, logo_path, name) VALUES (FALSE, 207, 107, 'programming text editor', '2017/11/10', 'w', 0, '<input type="image" src="/uploads/product_images/visualcode.jpg" width="30">', 'microsoft visual code');
INSERT INTO "Products" (hidden, product_id, user_id, description, release_date, operating_system, price, logo_path, name) VALUES (FALSE, 208, 108, 'digital audio editing suite software', '2002/7/12', 'wm', 199, '<input type="image" src="/uploads/product_images/soundforge.jpg" width="30">', 'sony sound forge');
INSERT INTO "Products" (hidden, product_id, user_id, description, release_date, operating_system, price, logo_path, name) VALUES (FALSE, 209, 109, 'dynamic mixing device', '2018/10/9', 'wml', 99, '<input type="image" src="/uploads/product_images/channelblender.jpg" width="30">', 'channel blender');
